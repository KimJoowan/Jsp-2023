        ...
        <article class="row">
            ...
            <div class="column1">
                <table class="main-search-Results-container">
                    ...
                    <tr>                     
                        <th>제품명<a href="/stakeholder/get?pcode=${a.pcode}"></a></th>
                        <td><a href="/stakeholder/get?pcode=${a.pcode}">${a.subject}</a></td>
                    </tr>
                    <tr>
                        <th>가격</th>
                        <td>${a.price}</td>
                ...
                <div class="main-search-Results-page-container">
                    <div class="d-flex justify-content-center">
						<ul class="pagination">
							<c:if test="${page.prev}">
								<li class="page-item">
									<a class="page-link" href="/stakeholder/productlist?pageNum=${page.startPage-1 }">Previous</a>
								</li>
							</c:if>
							<c:forEach var="num" begin="${page.startPage}" end="${page.endPage}">
								<li class="page-item ${page.cri.pageNum == num ? 'active':''}">
									<a class="page-link" href="/stakeholder/productlist?pageNum=${num}">${num}</a>
								</li>
							</c:forEach>
								<c:if test="${page.next}">
									<li class="page-item">
										<a class="page-link" href="/stakeholder/productlist?pageNum=${page.endPage+1 }">Next</a>
									</li>
								</c:if>
						</ul>
					</div>
